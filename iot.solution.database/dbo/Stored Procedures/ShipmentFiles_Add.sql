...
EXEC [dbo].[ShipmentFiles_Add]
	@tripGuid			= '895019CF-1D3E-420C-828F-8971253E5784'
	,@files					= '<files>
									<file>
										<path>path1</path>
										<desc>desc1</desc>
...
001	SG-18	14-02-2020	[Sunil Bhawsar]	Added Initial Version to Add Shipment Files

*******************************************************************/

CREATE PROCEDURE [dbo].[ShipmentFiles_Add]
